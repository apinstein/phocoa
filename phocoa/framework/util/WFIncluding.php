    ...
    static public function autoload($className)
    {
        ...
        if ($autoloadClassmapCache == NULL)
        {
             $autoloadClassmapCache = array(
                 ...
                 'WFFacetedSearchFacetBehavior'                  => 'framework/WFFacetedSearch.php',
                 'WFFacetedSearchFacetBehavior_DefinedRanges'    => 'framework/WFFacetedSearch.php',
                 'WFFacetedSearchFacetBehavior_NRanges'          => 'framework/WFFacetedSearch.php',
